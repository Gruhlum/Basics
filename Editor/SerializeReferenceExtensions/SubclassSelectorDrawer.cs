...
namespace MackySoft.SerializeReferenceExtensions.Editor
{
    ...
    public class SubclassSelectorDrawer : PropertyDrawer
    {
        ...
        private static readonly GUIContent k_NullDisplayName = new GUIContent(TypeMenuUtility.k_NullDisplayName);
        private static readonly GUIContent k_IsNotManagedReferenceLabel = new GUIContent("The property type is not manage reference.");

        private readonly Dictionary<string, TypePopupCache> m_TypePopups = new Dictionary<string, TypePopupCache>();
        private readonly Dictionary<string, GUIContent> m_TypeNameCaches = new Dictionary<string, GUIContent>();
        ...
        private TypePopupCache GetTypePopup(SerializedProperty property)
        {
            ...
            if (!m_TypePopups.TryGetValue(managedReferenceFieldTypename, out TypePopupCache result))
            {
                ...
                AdvancedTypePopup popup = new AdvancedTypePopup(
                ...
                popup.OnItemSelected += item =>
                {
                    ...
                    foreach (UnityEngine.Object targetObject in m_TargetProperty.serializedObject.targetObjects)
                    {
